...
Aura Team`,
   ...
   */
  'plan.upgraded': { pt: { subject: '🚀 Plano atualizado — {{companyName}}', title: 'Upgrade realizado!', body: 'Olá, {{adminName}}! Plano atualizado de {{oldPlan}} para {{newPlan}}. Novos limites já ativos.', whatsapp: '🚀 *{{companyName}}* — upgrade para *{{newPlan}}*!' }, en: { subject: '🚀 Plan upgraded — {{companyName}}', title: 'Upgrade successful!', body: 'Hi {{adminName}}! Plan upgraded from {{oldPlan}} to {{newPlan}}.', whatsapp: '🚀 *{{companyName}}* — upgraded to *{{newPlan}}*!' } },
  'plan.downgraded': { pt: { subject: 'ℹ️ Plano alterado — {{companyName}}', title: 'Plano alterado para {{newPlan}}', body: 'Olá, {{adminName}}! Plano alterado de {{oldPlan}} para {{newPlan}} ({{newPrice}}/mês). Novos limites em vigor.', whatsapp: 'ℹ️ *{{companyName}}* — plano alterado para *{{newPlan}}* ({{newPrice}}/mês).' }, en: { subject: 'ℹ️ Plan changed — {{companyName}}', title: 'Plan changed to {{newPlan}}', body: 'Hi {{adminName}}! Plan changed from {{oldPlan}} to {{newPlan}}.', whatsapp: 'ℹ️ *{{companyName}}* — plan changed to *{{newPlan}}*.' } },
  'billing.suspended': {
    pt: {
